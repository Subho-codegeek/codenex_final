...
module.exports.postQuestion = async function(req, res) {
  try {
    ...
    const username = req.user.name; // Assuming you have a way to get the logged-in user's username from the request
...
module.exports.addComment = async function(req, res){
  try {
    ...
    const userId = req.user._id; // Assuming you have a way to get the logged-in user ID from the request
